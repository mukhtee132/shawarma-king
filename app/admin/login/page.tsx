  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="hidden md:flex bg-black border-r-2 border-black flex-col items-center justify-center gap-6 p-16">
          <h2 className="bebas text-6xl uppercase text-white text-center leading-none">
            Admin<br />Access<br /><span className="text-[#F5C200]">Only.</span>
          </h2>
          <p className="text-white/50 text-center max-w-xs">
            This area is restricted to Shawarma King administrators only.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
            ...
            <div className="auth-field flex flex-col gap-2">
              ...
              <input
                {...register('email')}
                type="email"
                placeholder="admin@shawarmaking.com"
